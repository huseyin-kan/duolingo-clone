...
const QuestionBubble = ({question}:Props) => {
  return (
    <div className='flex items-center gap-x-6 mb-6'>
        <Image src={"/avatar.png"} alt='Avatar' height={60} width={60} className='hidden lg:block' />
        <Image src={"/avatar.png"} alt='Avatar' height={40} width={40} className='block lg:hidden' />
